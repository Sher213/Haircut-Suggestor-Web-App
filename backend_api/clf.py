...
faceCascade = cv2.CascadeClassifier(vals.PATH_1)
predictor = dlib.shape_predictor(vals.PATH_3)

#load classifiers
face_clf = pickle.load(open(vals.PATH_4, 'rb'))
hair_clf = pickle.load(open(vals.PATH_5, 'rb'))
